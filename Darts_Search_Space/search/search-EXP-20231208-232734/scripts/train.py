...
parser = argparse.ArgumentParser("isic2017")
parser.add_argument('--data', type=str, default='/sdb_new/wz/dataset/ISIC-2017', help='location of the data corpus')
parser.add_argument('--dataset', type=str, default='isic2017', help='cifar10 or cifar100')
...
parser.add_argument('--auxiliary', action='store_false', default=False, help='use auxiliary tower')
...
parser.add_argument('--arch', type=str, default='AGNAS', help='which architecture to use')
parser.add_argument('--grad_clip', type=float, default=5, help='gradient clipping')
args = parser.parse_args()

args.save = os.getcwd()+'/eval/eval-{}-{}'.format(args.save, time.strftime("%Y%m%d-%H%M%S"))
...
def main():
  ...
  if args.dataset == 'cifar10':
    ...
    data_transform = {
        ...
        T.RandomVerticalFlip(),
            T.ToTensor(),
            T.Normalize((0.7079058, 0.59156394, 0.54687256), (0.09372119, 0.11136281, 0.12577093))
            ]),
        "valid": T.Compose([
            T.Resize(size=(256, 256)),
            # T.RandomResizedCrop(224),
  ...
  valid_data = ImageFolder(args.data+'/valid', transform=data_transform["valid"])

  num_train = len(train_data)
  print("train-num:",num_train)
  num_valid = len(valid_data)
  print("valid-num:",num_valid)
